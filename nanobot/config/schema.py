...
class BrowserToolConfig(Base):
    """Managed browser tools configuration."""

    enable: bool = False
    headless: bool = True
    cdp_url: str | None = None  # Optional CDP endpoint, e.g. http://127.0.0.1:9222
    cdp_auto_launch_command: str | None = None  # Optional shell command used to start a CDP browser when the endpoint is down
    cdp_auto_launch_cwd: str | None = None  # Optional working directory for the auto-launch command
    cdp_auto_launch_delay_s: int = Field(default=3, ge=1, le=30)  # Seconds to wait before retrying CDP attach
